...
interface gas$Document$HeaderSection {
  ...
  clear(): gas$Document$HeaderSection;
  copy(): gas$Document$HeaderSection;
  ...
  removeChild(child: gas$Document$Element): gas$Document$HeaderSection;
  removeFromParent(): gas$Document$HeaderSection;
  replaceText(searchPattern: string, replacement: string): gas$Document$Element;
  setAttributes(attributes: Object): gas$Document$HeaderSection;
  setText(text: string): gas$Document$HeaderSection;
  setTextAlignment(textAlignment: gas$Document$TextAlignment): gas$Document$HeaderSection;
}
